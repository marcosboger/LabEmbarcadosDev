 ...
 * Command: /mongoose-os/tools/mgos_gen_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/data/fwbuild-volumes/2.19.1/apps/coreButton/esp32/build_contexts/build_ctx_640466063/build/gen/ /mongoose-os/src/mgos_debug_udp_config.yaml /mongoose-os/platforms/esp32/src/esp32_sys_config.yaml /data/fwbuild-volumes/2.19.1/apps/coreButton/esp32/build_contexts/build_ctx_640466063/build/gen/mos_conf_schema.yml
 */
...
/* blynk type struct mgos_config_blynk */
struct mgos_config_blynk {
  int enable;
  const char * server;
  const char * auth;
};
const struct mgos_conf_entry *mgos_config_blynk_get_schema(void);
void mgos_config_blynk_set_defaults(struct mgos_config_blynk *cfg);
static inline bool mgos_config_blynk_parse(struct mg_str json, struct mgos_config_blynk *cfg) {
  mgos_config_blynk_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_blynk_get_schema(), cfg);
}
static inline bool mgos_config_blynk_emit(const struct mgos_config_blynk *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_blynk_get_schema(), pretty, out);
}
static inline bool mgos_config_blynk_emit_f(const struct mgos_config_blynk *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_blynk_get_schema(), pretty, fname);
}
static inline bool mgos_config_blynk_copy(const struct mgos_config_blynk *src, struct mgos_config_blynk *dst) {
  return mgos_conf_copy(mgos_config_blynk_get_schema(), src, dst);
}
static inline void mgos_config_blynk_free(struct mgos_config_blynk *cfg) {
  return mgos_conf_free(mgos_config_blynk_get_schema(), cfg);
}
...
struct mgos_config {
  ...
  const char * conf_acl;
  struct mgos_config_blynk blynk;
...
/* blynk */
#define MGOS_CONFIG_HAVE_BLYNK
#define MGOS_SYS_CONFIG_HAVE_BLYNK
const struct mgos_config_blynk *mgos_config_get_blynk(const struct mgos_config *cfg);
static inline const struct mgos_config_blynk *mgos_sys_config_get_blynk(void) { return mgos_config_get_blynk(&mgos_sys_config); }

/* blynk.enable */
#define MGOS_CONFIG_HAVE_BLYNK_ENABLE
#define MGOS_SYS_CONFIG_HAVE_BLYNK_ENABLE
int mgos_config_get_blynk_enable(const struct mgos_config *cfg);
int mgos_config_get_default_blynk_enable(void);
static inline int mgos_sys_config_get_blynk_enable(void) { return mgos_config_get_blynk_enable(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_blynk_enable(void) { return mgos_config_get_default_blynk_enable(); }
void mgos_config_set_blynk_enable(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_blynk_enable(int v) { mgos_config_set_blynk_enable(&mgos_sys_config, v); }

/* blynk.server */
#define MGOS_CONFIG_HAVE_BLYNK_SERVER
#define MGOS_SYS_CONFIG_HAVE_BLYNK_SERVER
const char * mgos_config_get_blynk_server(const struct mgos_config *cfg);
const char * mgos_config_get_default_blynk_server(void);
static inline const char * mgos_sys_config_get_blynk_server(void) { return mgos_config_get_blynk_server(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_blynk_server(void) { return mgos_config_get_default_blynk_server(); }
void mgos_config_set_blynk_server(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_blynk_server(const char * v) { mgos_config_set_blynk_server(&mgos_sys_config, v); }

/* blynk.auth */
#define MGOS_CONFIG_HAVE_BLYNK_AUTH
#define MGOS_SYS_CONFIG_HAVE_BLYNK_AUTH
const char * mgos_config_get_blynk_auth(const struct mgos_config *cfg);
const char * mgos_config_get_default_blynk_auth(void);
static inline const char * mgos_sys_config_get_blynk_auth(void) { return mgos_config_get_blynk_auth(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_blynk_auth(void) { return mgos_config_get_default_blynk_auth(); }
void mgos_config_set_blynk_auth(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_blynk_auth(const char * v) { mgos_config_set_blynk_auth(&mgos_sys_config, v); }
