...
static const struct mgos_conf_entry mgos_config_schema_[] = {
    {.type = CONF_TYPE_OBJECT, .key = "", .offset = 0, .num_desc = 133},
    ...
    {.type = CONF_TYPE_OBJECT, .key = "blynk", .offset = offsetof(struct mgos_config, blynk), .num_desc = 3},
    {.type = CONF_TYPE_BOOL, .key = "enable", .offset = offsetof(struct mgos_config, blynk.enable)},
    {.type = CONF_TYPE_STRING, .key = "server", .offset = offsetof(struct mgos_config, blynk.server)},
    {.type = CONF_TYPE_STRING, .key = "auth", .offset = offsetof(struct mgos_config, blynk.auth)},
...
void mgos_config_blynk_set_defaults(struct mgos_config_blynk *cfg) {
  cfg->enable = true;
  cfg->server = "blynk-cloud.com:8442";
  cfg->auth = NULL;
}
...
const struct mgos_conf_entry *mgos_config_board_led2_get_schema(void) {
  return &mgos_config_schema_[119];
}
...
void mgos_config_set_defaults(struct mgos_config *cfg) {
  ...
  cfg->conf_acl = "*";
  mgos_config_blynk_set_defaults(&cfg->blynk);
...
/* blynk */
const struct mgos_config_blynk *mgos_config_get_blynk(const struct mgos_config *cfg) { return &cfg->blynk; }

/* blynk.enable */
int mgos_config_get_blynk_enable(const struct mgos_config *cfg) { return cfg->blynk.enable; }
int mgos_config_get_default_blynk_enable(void) { return true; }
void mgos_config_set_blynk_enable(struct mgos_config *cfg, int v) { cfg->blynk.enable = v; }

/* blynk.server */
const char * mgos_config_get_blynk_server(const struct mgos_config *cfg) { return cfg->blynk.server; }
const char * mgos_config_get_default_blynk_server(void) { return "blynk-cloud.com:8442"; }
void mgos_config_set_blynk_server(struct mgos_config *cfg, const char * v) { mgos_conf_set_str(&cfg->blynk.server, v); }

/* blynk.auth */
const char * mgos_config_get_blynk_auth(const struct mgos_config *cfg) { return cfg->blynk.auth; }
const char * mgos_config_get_default_blynk_auth(void) { return NULL; }
void mgos_config_set_blynk_auth(struct mgos_config *cfg, const char * v) { mgos_conf_set_str(&cfg->blynk.auth, v); }
